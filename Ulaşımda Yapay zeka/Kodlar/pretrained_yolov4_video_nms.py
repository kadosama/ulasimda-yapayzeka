...
file_video_stream = cv2.VideoCapture('Ulasımda_Yapay_Zeka_Yarismasi_Ornek_Video.mp4')
...
while True:
    ...
    yolo_model = cv2.dnn.readNetFromDarknet('C:/Users/Ezgi/Desktop/code/model/yolov3.cfg','C:/Users/Ezgi/Desktop/code/model/yolov3.weights')
